 ...
 */
inline bool WindowHasClassName(const Win32Window& window, const std::wstring& className) {
 ...
 */
inline std::optional<Win32Window> RecurseChildrenForProcessName(
  const Win32Window& window,
  const std::wstring& processName,
  const std::optional<std::wstring>& className
) {
 ...
 */
inline std::optional<Win32Window> GetWindowForProcessName(
  const std::wstring& processName,
  const std::optional<std::wstring>& className
) {
...
inline std::optional<Win32Window> RecurseChildrenForWindowTitle(
  const Win32Window& window,
  const std::wstring& title,
  const std::optional<std::wstring>& className,
 ...
 */
inline std::optional<Win32Window> GetWindowForWindowTitle(
  const std::wstring& title,
  const std::optional<std::wstring>& className
) {
