...
public class DarkModeCS {
  ...
  public enum DWMWINDOWATTRIBUTE : uint {
    /// <summary>
    ///   Use with DwmGetWindowAttribute. Discovers whether non-client rendering is enabled. The retrieved
    ///   value is of type BOOL. TRUE if non-client rendering is enabled; otherwise, FALSE.
    /// </summary>
    DWMWA_NCRENDERING_ENABLED = 1,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Sets the non-client rendering policy. The pvAttribute parameter
    ///   points to a value from the DWMNCRENDERINGPOLICY enumeration.
    /// </summary>
    DWMWA_NCRENDERING_POLICY,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Enables or forcibly disables DWM transitions. The pvAttribute
    ///   parameter points to a value of type BOOL. TRUE to disable transitions, or FALSE to enable
    ///   transitions.
    /// </summary>
    DWMWA_TRANSITIONS_FORCEDISABLED,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Enables content rendered in the non-client area to be visible on
    ///   the frame drawn by DWM. The pvAttribute parameter points to a value of type BOOL. TRUE to enable
    ///   content rendered in the non-client area to be visible on the frame; otherwise, FALSE.
    /// </summary>
    DWMWA_ALLOW_NCPAINT,

    /// <summary>
    ///   Use with DwmGetWindowAttribute. Retrieves the bounds of the caption button area in the
    ///   window-relative space. The retrieved value is of type RECT. If the window is minimized or
    ///   otherwise not visible to the user, then the value of the RECT retrieved is undefined. You should
    ///   check whether the retrieved RECT contains a boundary that you can work with, and if it doesn't
    ///   then you can conclude that the window is minimized or otherwise not visible.
    /// </summary>
    DWMWA_CAPTION_BUTTON_BOUNDS,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Specifies whether non-client content is right-to-left (RTL)
    ///   mirrored. The pvAttribute parameter points to a value of type BOOL. TRUE if the non-client
    ///   content is right-to-left (RTL) mirrored; otherwise, FALSE.
    /// </summary>
    DWMWA_NONCLIENT_RTL_LAYOUT,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Forces the window to display an iconic thumbnail or peek
    ///   representation (a static bitmap), even if a live or snapshot representation of the window is
    ///   available. This value is normally set during a window's creation, and not changed throughout the
    ///   window's lifetime. Some scenarios, however, might require the value to change over time. The
    ///   pvAttribute parameter points to a value of type BOOL. TRUE to require a iconic thumbnail or peek
    ///   representation; otherwise, FALSE.
    /// </summary>
    DWMWA_FORCE_ICONIC_REPRESENTATION,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Sets how Flip3D treats the window. The pvAttribute parameter
    ...
    /// <summary>
    ///   Use with DwmSetWindowAttribute. The window will provide a bitmap for use by DWM as an iconic
    ///   thumbnail or peek representation (a static bitmap) for the window. DWMWA_HAS_ICONIC_BITMAP can be
    ///   specified with DWMWA_FORCE_ICONIC_REPRESENTATION. DWMWA_HAS_ICONIC_BITMAP normally is set during
    ///   a window's creation and not changed throughout the window's lifetime. Some scenarios, however,
    ///   might require the value to change over time. The pvAttribute parameter points to a value of type
    ///   BOOL. TRUE to inform DWM that the window will provide an iconic thumbnail or peek representation;
    ///   otherwise, FALSE. Windows Vista and earlier: This value is not supported.
    /// </summary>
    DWMWA_HAS_ICONIC_BITMAP,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Do not show peek preview for the window. The peek view shows a
    ///   full-sized preview of the window when the mouse hovers over the window's thumbnail in the
    ///   taskbar. If this attribute is set, hovering the mouse pointer over the window's thumbnail
    ///   dismisses peek (in case another window in the group has a peek preview showing). The pvAttribute
    ///   parameter points to a value of type BOOL. TRUE to prevent peek functionality, or FALSE to allow
    ///   it. Windows Vista and earlier: This value is not supported.
    /// </summary>
    DWMWA_DISALLOW_PEEK,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Prevents a window from fading to a glass sheet when peek is
    ///   invoked. The pvAttribute parameter points to a value of type BOOL. TRUE to prevent the window
    ///   from fading during another window's peek, or FALSE for normal behavior. Windows Vista and
    ///   earlier: This value is not supported.
    /// </summary>
    DWMWA_EXCLUDED_FROM_PEEK,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Cloaks the window such that it is not visible to the user. The
    ///   window is still composed by DWM. Using with DirectComposition: Use the DWMWA_CLOAK flag to cloak
    ///   the layered child window when animating a representation of the window's content via a
    ///   DirectComposition visual that has been associated with the layered child window. For more details
    ///   on this usage case, see How to animate the bitmap of a layered child window. Windows 7 and
    ///   earlier: This value is not supported.
    /// </summary>
    DWMWA_CLOAK,
    ...
    ///   explaining why. DWM_CLOAKED_APP (value 0x0000001). The window was cloaked by its owner
    ///   application. DWM_CLOAKED_SHELL(value 0x0000002). The window was cloaked by the Shell.
    ...
    /// <summary>
    ///   Use with DwmSetWindowAttribute. Freeze the window's thumbnail image with its current visuals. Do
    ///   no further live updates on the thumbnail image to match the window's contents. Windows 7 and
    ///   earlier: This value is not supported.
    /// </summary>
    DWMWA_FREEZE_REPRESENTATION,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Enables a non-UWP window to use host backdrop brushes. If this
    ///   flag is set, then a Win32 app that calls Windows::UI::Composition APIs can build transparency
    ///   effects using the host backdrop brush (see Compositor.CreateHostBackdropBrush). The pvAttribute
    ///   parameter points to a value of type BOOL. TRUE to enable host backdrop brushes for the window, or
    ///   FALSE to disable it. This value is supported starting with Windows 11 Build 22000.
    /// </summary>
    DWMWA_USE_HOSTBACKDROPBRUSH,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Allows the window frame for this window to be drawn in dark mode
    ///   colors when the dark mode system setting is enabled. For compatibility reasons, all windows
    ///   default to light mode regardless of the system setting. The pvAttribute parameter points to a
    ///   value of type BOOL. TRUE to honor dark mode for the window, FALSE to always use light mode. This
    ///   value is supported starting with Windows 10 Build 17763.
    /// </summary>
    ...
    ///   default to light mode regardless of the system setting. The pvAttribute parameter points to a
    ///   value of type BOOL. TRUE to honor dark mode for the window, FALSE to always use light mode. This
    ///   value is supported starting with Windows 11 Build 22000.
    /// </summary>
    DWMWA_USE_IMMERSIVE_DARK_MODE = 20,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Specifies the rounded corner preference for a window. The
    ///   pvAttribute parameter points to a value of type DWM_WINDOW_CORNER_PREFERENCE. This value is
    ///   supported starting with Windows 11 Build 22000.
    /// </summary>
    DWMWA_WINDOW_CORNER_PREFERENCE = 33,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Specifies the color of the window border. The pvAttribute
    ///   parameter points to a value of type COLORREF. The app is responsible for changing the border
    ///   color according to state changes, such as a change in window activation. This value is supported
    ///   starting with Windows 11 Build 22000.
    /// </summary>
    DWMWA_BORDER_COLOR,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Specifies the color of the caption. The pvAttribute parameter
    ///   points to a value of type COLORREF. This value is supported starting with Windows 11 Build 22000.
    /// </summary>
    DWMWA_CAPTION_COLOR,

    /// <summary>
    ///   Use with DwmSetWindowAttribute. Specifies the color of the caption text. The pvAttribute
    ///   parameter points to a value of type COLORREF. This value is supported starting with Windows 11
    ///   Build 22000.
    /// </summary>
    DWMWA_TEXT_COLOR,

    /// <summary>
    ///   Use with DwmGetWindowAttribute. Retrieves the width of the outer border that the DWM would draw
    ///   around this window. The value can vary depending on the DPI of the window. The pvAttribute
    ///   parameter points to a value of type UINT. This value is supported starting with Windows 11 Build
    ///   22000.
    /// </summary>
  ...
  [DllImport("user32")] private static extern nint ReleaseDC(nint hwnd, nint hdc);
  ...
  public DarkModeCS(Form _Form, bool _ColorizeIcons = true, bool _RoundedPanels = false) {
    ...
    _Form.Load += (sender, e) => {
      IsDarkMode = isDarkMode(); //<- Gets the current color mode from Windows
      if (ColorMode != DisplayMode.SystemDefault) {
        IsDarkMode = ColorMode == DisplayMode.DarkMode ? true : false;
      }
  ...
  public void ApplyTheme(bool pIsDarkMode = true) {
    try {
      ...
      IsDarkMode = IsDarkMode != pIsDarkMode ? pIsDarkMode : IsDarkMode;
  ...
  public void ThemeControl(Control control) {
    ...
    var BStyle = IsDarkMode ? BorderStyle.FixedSingle : BorderStyle.Fixed3D;
    var FStyle = IsDarkMode ? FlatStyle.Flat : FlatStyle.Standard;

    if (controlHandleCreated == null) {
      controlHandleCreated = (sender, e) => { ApplySystemDarkTheme((Control)sender, IsDarkMode); };
    }
    ...
    if (controlControlAdded == null) {
      controlControlAdded = (sender, e) => { ThemeControl(e.Control); };
    }

    control.ControlAdded -= controlControlAdded; //prevent uncontrolled multiple addition
    control.ControlAdded += controlControlAdded;

    var Mode = IsDarkMode ? "DarkMode_Explorer" : "ClearMode_Explorer";
    SetWindowTheme(
      control.Handle,
      Mode,
      null
    ); //<- Attempts to apply Dark Mode using Win32 API if available.
      ...
      control.Paint += (sender, e) => {
        if (control.Enabled == false && IsDarkMode) {
          ...
          using (Brush B = new SolidBrush(control.ForeColor)) {
            ...
            var mi = lbl.GetType()
              .GetMethod("CreateStringFormat", BindingFlags.NonPublic | BindingFlags.Instance);
    ...
    if (control is TextBox textBox) {
      ...
      textBox.BackColor =
        IsDarkMode ? OScolors.Control : SystemColors.ControlLightLight;
    }
    ...
    if (control is Button) {
      ...
      button.BackColor = IsDarkMode ? OScolors.Control : SystemColors.ControlLightLight;
      ...
      control.Paint += (sender, e) => {
        if (IsDarkMode) {
          ...
          using (var p = new Pen(SystemColors.ControlDarkDark)) {
            ...
            var addText = !string.IsNullOrEmpty(groupBox.Text);
            var txt     = addText ? groupBox.Text : "H";
            var strSize = g.MeasureString(txt, groupBox.Font);
            ...
            var paddingLeft = addText ? groupBox.Padding.Left : (int)strSize.Width;
            ...
            if (addText) {
              ...
              g.DrawLine(
                ...
                new Point(rect.X + groupBox.Padding.Left, rect.Y)
              );
              //Top2
              g.DrawLine(
                p,
                new Point(rect.X + groupBox.Padding.Left + (int)strSize.Width, rect.Y),
                new Point(rect.X + rect.Width, rect.Y)
              );
            }
            else {
              //Top1
              g.DrawLine(p, new Point(rect.X, rect.Y), new Point(rect.X + groupBox.Width, rect.Y));
            }
          }
    ...
    if (control is ToolStrip) {
      ...
      (control as ToolStrip).Renderer =
        new MyRenderer(new CustomColorTable(OScolors), ColorizeIcons) { MyColors = OScolors };
    }
    ...
    if (control is ContextMenuStrip) {
      ...
      (control as ContextMenuStrip).Renderer =
        new MyRenderer(new CustomColorTable(OScolors), ColorizeIcons) { MyColors = OScolors };
    ...
    if (control is DataGridView) {
      ...
      grid.Paint += (sender, e) => {
        ...
        var hs = (HScrollBar)typeof(DataGridView).GetProperty(
            "HorizontalScrollBar",
        ...
        if (hs.Visible) {
          ...
          var vs = (VScrollBar)typeof(DataGridView).GetProperty(
              "VerticalScrollBar",
              BindingFlags.Instance | BindingFlags.NonPublic
            )
            .GetValue(dgv);
          ...
          if (vs.Visible) {
            ...
            e.Graphics.FillRectangle(
              ...
              dgv.ClientRectangle.Y + dgv.ClientRectangle.Height - h - 1,
              w,
              h
            );
          }
    ...
    Debug.Print("{0}: {1}", control.Name, control.GetType().Name);
  ...
  ///   Call it before applying the theme to your Form (or to any other Control containing (directly or
  ///   indirectly) this Control)
  /// </summary>
  ...
  /// <returns>
  ///   List of Colors:  Background, OnBackground, Surface, OnSurface, Primary, OnPrimary, Secondary,
  ///   OnSecondary
  /// </returns>
  public static OSThemeColors
    GetSystemColors(Form Window = null, int ColorMode = 0) //<- O: DarkMode, 1: LightMode
  {
    ...
    if (_Control != null) {
      ...
      _Control.Paint += (sender, e) => {
        ...
        if (Radius > 1) //Rounded TextBox
        {
          ...
          using (var pathBorderSmooth = GetFigurePath(rectBorderSmooth, Radius)) {
            using (var pathBorder = GetFigurePath(rectBorder, Radius - borderSize)) {
              using (var penBorderSmooth = new Pen(_Control.Parent.BackColor, smoothSize)) {
                using (var penBorder = new Pen((Color)borderColor, borderSize)) {
                  //-Drawing
                  _Control.Region =
                    new Region(pathBorderSmooth); //Set the rounded region of UserControl
  ...
  private void Tsdd_Opening(object sender, CancelEventArgs e) {
    ...
    foreach (var toolStripMenuItem in tsdd.Items.OfType<ToolStripMenuItem>()) {
  ...
  private static void ApplySystemDarkTheme(Control control = null, bool IsDarkMode = true) {
    /*
       ...
       */
    var DarkModeOn = IsDarkMode ? new[] { 0x01 } : new[] { 0x00 }; //<- 1=True, 0=False
    var Mode       = IsDarkMode ? "DarkMode_Explorer" : "ClearMode_Explorer";
    ...
    SetWindowTheme(
      ...
      Mode,
      null
    ); //DarkMode_Explorer, ClearMode_Explorer, DarkMode_CFD, DarkMode_ItemsView,
...
public class MyRenderer : ToolStripProfessionalRenderer {
  ...
  protected override void OnRenderButtonBackground(ToolStripItemRenderEventArgs e) {
    ...
    var gradientBegin = MyColors.Background; // Color.FromArgb(203, 225, 252);
    var gradientEnd   = MyColors.Background;
  ...
  protected override void OnRenderItemImage(ToolStripItemImageRenderEventArgs e) {
    if (e.Item.GetType().FullName == "System.Windows.Forms.MdiControlStrip+ControlBoxMenuItem") {
      ...
      var image       = e.Image;
      var _ClearColor = e.Item.Enabled ? MyColors.TextActive : MyColors.SurfaceDark;
    ...
    if (ColorizeIcons && e.Image != null) {
      ...
      var image       = e.Image;
      var _ClearColor = e.Item.Enabled ? MyColors.TextInactive : MyColors.SurfaceDark;
  ...
  protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e) {
    ...
    var gradientBegin = MyColors.Background; // Color.FromArgb(203, 225, 252);
    var gradientEnd   = MyColors.Background; // Color.FromArgb(125, 165, 224);
...
public class ControlStatusStorage {
  /// <summary>
  ///   Storage for the data. ConditionalWeakTable ensures there are no unnecessary references left,
  ...
  /// </summary>
  /// <returns>
  ///   a ControlStatusInfo object if the control has been already processed or marked for exclusion,
  ///   null otherwise
  /// </returns>
  public ControlStatusInfo GetControlStatusInfo(Control control) {
    _controlsProcessed.TryGetValue(control, out var info);
    return info;
  }


  public void RegisterProcessedControl(Control control, bool isDarkMode) {
    _controlsProcessed.Add(
      control,
