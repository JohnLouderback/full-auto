...
const ELECTRON_DIST_PATH = path.resolve(__dirname, '../node_modules/electron/dist');
...
const DOWNLOAD_URL = 'https://github.com/win32ss/supermium-electron/releases/download/v28-testing/dist_x64.zip';
...
(async () => {
    ...
    console.log(`Supermium-Electron update required (Stored: ${storedHash || 'None'}, Current: ${currentHash || 'Missing'})`);
